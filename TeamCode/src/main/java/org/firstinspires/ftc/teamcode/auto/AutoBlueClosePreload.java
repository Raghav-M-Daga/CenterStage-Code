...
public class AutoBlueClosePreload extends LinearOpMode {
    OpenCvCamera camera;
    DetectionPipeline detectionPipeline;
    Babaji babaji;
    public static double leftPosX = -14, leftPosY = -12.5, leftPosAngle = 0, backdropScoreLeftX = -20.5;
    public static double rightPosX = -27.5, rightPosY = -3, rightPosAngle = 270, backdropScoreRightX = -31.5;
    public static double midPosX = -23, midPosY = -4, midPosAngle = 0, backdropScoreMidX = -256;
    public static double backdropScoreAngle = 90, backdropScoreY = -39.5;
    public static double parkX = -5, parkY = -34;
