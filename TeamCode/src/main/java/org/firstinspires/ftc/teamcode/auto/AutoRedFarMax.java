...
public class AutoRedFarMax extends LinearOpMode {
    OpenCvCamera camera;
    DetectionPipeline detectionPipeline;
    Sensors sensor;
    Babaji babaji;
    public static double preloadX = -27, preloadY = 0.5, preloadAngle = 0;
    public static double intakeX = -25, intakeX2 = -24.5, intakeX3 = -23, intakeY = -18, intakeY2 = -14, intakeYStep = -5, intakeAngle = 270;
    public static double setUpX = -27;
    public static double straightEndX = -25, straightEndY = 60, straightInterpol = 90;
    public static double backdropScoreAngle = 270, backdropScoreInterpol = 90, backDropScoreY = 87;
    public static double backdropScoreWhites = -34, backDropScoreY2 = 86.5;
    public static double backdropScoreYellow = -31, backdropScoreWhite = -17;
    public static double parkX = -5, parkY = 77;
    public static double slideEncCount = 4000;
    ...
    public static long outtakeTime1 = 100, outtakeTime2 = 100, outtakeTime3 = 100;
